(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('hammerjs'), require('cornerstone-core'), require('cornerstone-math'), require('cornerstone-tools'), require('react'), require('cornerstone-wado-image-loader'), require('dicom-parser'), require('react-resize-detector'), require('ohif-core'), require('react-redux'), require('prop-types'), require('dcmjs')) :
	typeof define === 'function' && define.amd ? define(['hammerjs', 'cornerstone-core', 'cornerstone-math', 'cornerstone-tools', 'react', 'cornerstone-wado-image-loader', 'dicom-parser', 'react-resize-detector', 'ohif-core', 'react-redux', 'prop-types', 'dcmjs'], factory) :
	(global = global || self, global['ohif-cornerstone-extension'] = factory(global.Hammer, global.cornerstone, global.cornerstoneMath, global.cornerstoneTools, global.React, global.cornerstoneWADOImageLoader, global.dicomParser, global.ReactResizeDetector, global.OHIF, global.ReactRedux, global.PropTypes, global.dcmjs));
}(this, function (Hammer, cornerstone, cornerstoneMath, cornerstoneTools, React, cornerstoneWADOImageLoader, dicomParser, ReactResizeDetector, OHIF, reactRedux, PropTypes, dcmjs) { 'use strict';
	...
	OHIF = OHIF && OHIF.hasOwnProperty('default') ? OHIF['default'] : OHIF;
	...
	*/
	...
	var ConnectedCornerstoneViewport = reactRedux.connect(mapStateToProps, mapDispatchToProps)(CornerstoneViewport);
	...
	function parseSeg(arrayBuffer, imageIds) {
	  return dcmjs.adapters.Cornerstone.Segmentation.generateToolState(imageIds, arrayBuffer, cornerstone.metaData);
	}
	...
	function (_Component) {
	  ...
	  createClass(OHIFCornerstoneViewport, [{
	    ...
	    value: function render() {
	      ...
	      return React__default.createElement(React__default.Fragment, null, this.state.viewportData && React__default.createElement(ConnectedCornerstoneViewport, _extends_1({
