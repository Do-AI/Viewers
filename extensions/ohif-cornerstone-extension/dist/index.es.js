...
import { data, adapters } from 'dcmjs';
...
cornerstoneTools.init(); // Set the tool font and font size
...
cornerstoneTools.textStyle.setFont("16px ".concat(fontFamily)); // Tool styles/colors
...
function (_PureComponent) {
  inherits$1(ImageScrollbar, _PureComponent);
  ...
  function ImageScrollbar() {
    ...
    classCallCheck$1(this, ImageScrollbar);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = possibleConstructorReturn$1(this, (_getPrototypeOf2 = getPrototypeOf$1(ImageScrollbar)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onChange", function (event) {
      var intValue = parseInt(event.target.value, 10);

      _this.props.onInputCallback(intValue);
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onKeyDown", function (event) {
...
defineProperty$1(ImageScrollbar, "propTypes", {
...
(function (global, factory) {
    ...
    function getSetGlobalLocale (key, values) {
        ...
        if (key) {
            if (isUndefined(values)) {
                data$$1 = getLocale(key);
            }
            else {
                data$$1 = defineLocale(key, values);
            }
    ...
    function abs () {
        ...
        data$$1.milliseconds  = mathAbs(data$$1.milliseconds);
        data$$1.seconds       = mathAbs(data$$1.seconds);
        data$$1.minutes       = mathAbs(data$$1.minutes);
        data$$1.hours         = mathAbs(data$$1.hours);
        data$$1.months        = mathAbs(data$$1.months);
        data$$1.years         = mathAbs(data$$1.years);
    ...
    function bubble () {
        ...
        data$$1.milliseconds = milliseconds % 1000;

        seconds           = absFloor(milliseconds / 1000);
        data$$1.seconds      = seconds % 60;

        minutes           = absFloor(seconds / 60);
        data$$1.minutes      = minutes % 60;

        hours             = absFloor(minutes / 60);
        data$$1.hours        = hours % 24;
...
/*#__PURE__*/
function (_PureComponent) {
  inherits$1(ViewportOverlay, _PureComponent);

  function ViewportOverlay() {
    classCallCheck$1(this, ViewportOverlay);

    return possibleConstructorReturn$1(this, getPrototypeOf$1(ViewportOverlay).apply(this, arguments));
  }

  createClass$1(ViewportOverlay, [{
    key: "render",
    value: function render() {
      ...
      }, React.createElement("div", null, "Zoom: ", formatNumberPrecision$1(zoom, 0), "%"), React.createElement("div", null, wwwc), React.createElement("div", {
        className: "compressionIndicator"
      }, compression)), React.createElement("div", {
        className: "bottom-left overlay-element"
      }, React.createElement("div", null, seriesNumber >= 0 ? "Ser: ".concat(seriesNumber) : ''), React.createElement("div", null, numImages > 1 ? "Img: ".concat(instanceNumber, " ").concat(imageIndex, "/").concat(numImages) : ''), React.createElement("div", null, frameRate >= 0 ? "".concat(formatNumberPrecision$1(frameRate, 2), " FPS") : '', React.createElement("div", null, imageDimensions), React.createElement("div", null, isValidNumber$1(sliceLocation) ? "Loc: ".concat(formatNumberPrecision$1(sliceLocation, 2), " mm ") : '', sliceThickness ? "Thick: ".concat(formatNumberPrecision$1(sliceThickness, 2), " mm") : ''), React.createElement("div", null, seriesDescription))));
      var rightOnly = React.createElement(React.Fragment, null, React.createElement("div", {
        className: "top-right overlay-element"
      }, React.createElement("div", null, formatPN$1(patientName)), React.createElement("div", null, patientId), React.createElement("div", null, studyDescription), React.createElement("div", null, formatDA$1(studyDate), " ", formatTM$1(studyTime))), React.createElement("div", {
        className: "bottom-right overlay-element"
      }, React.createElement("div", null, seriesNumber >= 0 ? "Ser: ".concat(seriesNumber) : ''), React.createElement("div", null, numImages > 1 ? "Img: ".concat(instanceNumber, " ").concat(imageIndex, "/").concat(numImages) : ''), React.createElement("div", null, frameRate >= 0 ? "".concat(formatNumberPrecision$1(frameRate, 2), " FPS") : ''), React.createElement("div", null, imageDimensions), React.createElement("div", null, seriesDescription), React.createElement("div", null, "Zoom: ", formatNumberPrecision$1(zoom, 0), "%"), React.createElement("div", {
        className: "compressionIndicator"
      }, compression), React.createElement("div", null, wwwc)));
      var leftOnly = React.createElement(React.Fragment, null, React.createElement("div", {
        className: "top-left overlay-element"
      }, React.createElement("div", null, formatPN$1(patientName)), React.createElement("div", null, patientId), React.createElement("div", null, studyDescription), React.createElement("div", null, formatDA$1(studyDate), " ", formatTM$1(studyTime))), React.createElement("div", {
        className: "bottom-left overlay-element"
      }, React.createElement("div", null, seriesNumber >= 0 ? "Ser: ".concat(seriesNumber) : ''), React.createElement("div", null, numImages > 1 ? "Img: ".concat(instanceNumber, " ").concat(imageIndex, "/").concat(numImages) : ''), React.createElement("div", null, frameRate >= 0 ? "".concat(formatNumberPrecision$1(frameRate, 2), " FPS") : ''), React.createElement("div", null, imageDimensions), React.createElement("div", null, seriesDescription), React.createElement("div", null, "Zoom: ", formatNumberPrecision$1(zoom, 0), "%"), React.createElement("div", {
...
defineProperty$1(ViewportOverlay, "propTypes", {
...
/*#__PURE__*/
function (_PureComponent) {
  inherits$1(LoadingIndicator, _PureComponent);

  function LoadingIndicator() {
    classCallCheck$1(this, LoadingIndicator);

    return possibleConstructorReturn$1(this, getPrototypeOf$1(LoadingIndicator).apply(this, arguments));
  }
  ...
  createClass$1(LoadingIndicator, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, this.props.error ? React.createElement("div", {
        ...
        className: "indicatorContents"
      }, React.createElement("p", null, "Loading... ", React.createElement("i", {
...
defineProperty$1(LoadingIndicator, "propTypes", {
  percentComplete: propTypes.number.isRequired,
  error: propTypes.object
});

defineProperty$1(LoadingIndicator, "defaultProps", {
  percentComplete: 0,
  error: null
});
...
/*#__PURE__*/
function (_PureComponent) {
  inherits$1(ViewportOrientationMarkers, _PureComponent);

  function ViewportOrientationMarkers() {
    classCallCheck$1(this, ViewportOrientationMarkers);

    return possibleConstructorReturn$1(this, getPrototypeOf$1(ViewportOrientationMarkers).apply(this, arguments));
  }

  createClass$1(ViewportOrientationMarkers, [{
    key: "render",
    value: function render() {
...
defineProperty$1(ViewportOrientationMarkers, "propTypes", {
  imageId: propTypes.string.isRequired,
  viewport: propTypes.object.isRequired
});
...
function initializeTools(cornerstoneTools$$1, tools, element) {
  Array.from(tools).forEach(function (tool) {
    ...
    if (apiTool) {
      cornerstoneTools$$1.addToolForElement(element, apiTool, tool.props);
    } else {
...
/*#__PURE__*/
function (_Component) {
  inherits$1(CornerstoneViewport, _Component);

  function CornerstoneViewport(props) {
    var _this;

    classCallCheck$1(this, CornerstoneViewport);

    _this = possibleConstructorReturn$1(this, getPrototypeOf$1(CornerstoneViewport).call(this, props)); // TODO: Allow viewport as a prop

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "updateViewportSpecificData", function () {
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onContextMenu", function (event) {
      event.preventDefault();
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onWindowResize", function () {
      _this.debouncedResize();
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onImageRendered", function (event) {
      _this.setState({
        viewport: Object.assign({}, event.detail.viewport)
      });
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onNewImage", function (event) {
      _this.setState({
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onDoubleClick", function (event) {
      if (_this.props.onDoubleClick) {
        _this.props.onDoubleClick(event);
      }
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "setActiveTool", function (activeTool) {
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onStackScroll", function (event) {
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onImageLoaded", function () {
      _this.setState({
        numImagesLoaded: _this.state.numImagesLoaded + 1
      });
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "startLoadingHandler", function () {
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "doneLoadingHandler", function () {
      clearTimeout(_this.loadHandlerTimeout);
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onMeasurementAdded", function (event) {
      if (_this.props.onMeasurementsChanged) {
        _this.props.onMeasurementsChanged(event, 'added');
      }
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onMeasurementRemoved", function (event) {
      if (_this.props.onMeasurementsChanged) {
        _this.props.onMeasurementsChanged(event, 'removed');
      }
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onMeasurementModified", function (event) {
      if (_this.props.onMeasurementsChanged) {
        _this.props.onMeasurementsChanged(event, 'modified');
      }
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "setViewportActive", function () {
      if (!_this.props.isActive && _this.props.setViewportActive) {
        _this.props.setViewportActive();
      }
    });

    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onMouseClick", function (event) {
      _this.setViewportActive();
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onTouchPress", function (event) {
      _this.setViewportActive();
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "onTouchStart", function () {
      _this.setViewportActive();
    ...
    defineProperty$1(assertThisInitialized$1(assertThisInitialized$1(_this)), "imageSliderOnInputCallback", function (value) {
      _this.setViewportActive();
  ...
  createClass$1(CornerstoneViewport, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      var getOverlay = function getOverlay() {
        var Component$$1 = _this2.props.viewportOverlayComponent;
      ...
      return React.createElement("div", {
        className: className
      }, ReactResizeDetector && React.createElement(ReactResizeDetector, {
        handleWidth: true,
        handleHeight: true,
      ...
      }, displayLoadingIndicator && React.createElement(LoadingIndicator, {
        error: this.state.error
      }), React.createElement("canvas", {
        className: "cornerstone-canvas"
      }), getOverlay(), React.createElement(ViewportOrientationMarkers, {
        imageId: this.state.imageId,
        viewport: this.state.viewport
      })), React.createElement(ImageScrollbar, {
    ...
    value: function componentDidMount() {
      ...
      this.eventHandlerData.forEach(function (data$$1) {
        var eventTarget = data$$1.eventTarget,
            eventType = data$$1.eventType,
            handler = data$$1.handler;
...
defineProperty$1(CornerstoneViewport, "defaultProps", {
  activeTool: 'Wwwc',
  viewportData: {
    stack: {
      imageIds: [],
...
defineProperty$1(CornerstoneViewport, "propTypes", {
...
defineProperty$1(CornerstoneViewport, "loadIndicatorDelay", 45);
...
var _OHIF$redux$actions = OHIF.redux.actions,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  ...
  return {
    ...
    setViewportSpecificData: function setViewportSpecificData(data$$1) {
      dispatch(_setViewportSpecificData(viewportIndex, data$$1));
    },
    ...
    onMeasurementsChanged: function onMeasurementsChanged(event, action) {
      var _OHIF$measurements$Me = OHIF.measurements.MeasurementHandlers,
          onAdded = _OHIF$measurements$Me.onAdded,
          onRemoved = _OHIF$measurements$Me.onRemoved,
          onModified = _OHIF$measurements$Me.onModified;
      var actions = {
        added: onAdded,
        removed: onRemoved,
        modified: lodash_throttle(function (event) {
...
var ConnectedCornerstoneViewport = connect(mapStateToProps, mapDispatchToProps)(CornerstoneViewport);

var StackManager = OHIF.utils.StackManager;
...
function getDisplaySetsBySeries(studies, studyInstanceUid, seriesInstanceUid) {
  ...
  return study.displaySets.filter(function (set) {
    return set.seriesInstanceUid === seriesInstanceUid;
  });
}

function parseSeg(arrayBuffer, imageIds) {
  return adapters.Cornerstone.Segmentation.generateToolState(imageIds, arrayBuffer, cornerstone.metaData);
}

function addSegMetadataToCornerstoneToolState(segMetadata, toolState, displaySetInstanceUid) {
  cornerstoneTools.globalImageIdSpecificToolStateManager.restoreToolState(toolState);
  var brushModule = cornerstoneTools.store.modules.brush;

  for (var i = 0; i < segMetadata.length; i++) {
...
function handleSegmentationStorage(_x, _x2, _x3) {
  return _handleSegmentationStorage.apply(this, arguments);
}

function _handleSegmentationStorage() {
  _handleSegmentationStorage = asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee(studies, studyInstanceUid, displaySetInstanceUid) {
    var study, displaySet, segWadoUri, arrayBuffer, dicomData, dataset, seriesInstanceUid, displaySets, referenceDisplaySet, imageIds, results, segMetadata, toolState, cachedStack, stack;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            study = studies.find(function (study) {
              return study.studyInstanceUid === studyInstanceUid;
            });
            displaySet = getDisplaySet(studies, studyInstanceUid, displaySetInstanceUid);
            segWadoUri = displaySet.images[0].getData().wadouri;
            _context.next = 5;
            return retrieveDicomData(segWadoUri);

          case 5:
            arrayBuffer = _context.sent;
            dicomData = data.DicomMessage.readFile(arrayBuffer);
            dataset = data.DicomMetaDictionary.naturalizeDataset(dicomData.dict);
            dataset._meta = data.DicomMetaDictionary.namifyDataset(dicomData.meta);
            seriesInstanceUid = dataset.ReferencedSeriesSequence.SeriesInstanceUID;
            displaySets = getDisplaySetsBySeries(studies, studyInstanceUid, seriesInstanceUid);

            if (displaySets.length > 1) {
              console.warn('More than one display set with the same seriesInstanceUid. This is not supported yet...');
            }

            referenceDisplaySet = displaySets[0];
            imageIds = referenceDisplaySet.images.map(function (image) {
              return image.getImageId();
            });
            results = parseSeg(arrayBuffer, imageIds);
          ...
          case 17:
            segMetadata = results.segMetadata, toolState = results.toolState;
            segMetadata.seriesInstanceUid = seriesInstanceUid;
            addSegMetadataToCornerstoneToolState(segMetadata, toolState, displaySetInstanceUid);
            cachedStack = StackManager.findOrCreateStack(study, referenceDisplaySet);
            stack = Object.assign({}, cachedStack);
...
var StackManager$1 = OHIF.utils.StackManager; // Metadata configuration

var metadataProvider = new OHIF.cornerstone.MetadataProvider();
...
var specialCaseHandlers = {};
specialCaseHandlers[SOP_CLASSES.SEGMENTATION_STORAGE] = handleSegmentationStorage;

var OHIFCornerstoneViewport =
/*#__PURE__*/
function (_Component) {
  inherits(OHIFCornerstoneViewport, _Component);
  ...
  function OHIFCornerstoneViewport() {
    ...
    classCallCheck(this, OHIFCornerstoneViewport);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf(OHIFCornerstoneViewport)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "state", {
      viewportData: null
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "getViewportData",
    /*#__PURE__*/
    function () {
      var _ref = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee(studies, studyInstanceUid, displaySetInstanceUid, sopClassUid, sopInstanceUid, frameIndex) {
        var viewportData, specialCaseHandler, stack;
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = sopClassUid;
                _context.next = _context.t0 === SOP_CLASSES.SEGMENTATION_STORAGE ? 3 : 8;
                break;

              case 3:
                specialCaseHandler = specialCaseHandlers[SOP_CLASSES.SEGMENTATION_STORAGE];
                _context.next = 6;
                return specialCaseHandler(studies, studyInstanceUid, displaySetInstanceUid, sopInstanceUid, frameIndex);
              ...
              case 8:
                stack = OHIFCornerstoneViewport.getViewportData(studies, studyInstanceUid, displaySetInstanceUid, sopInstanceUid, frameIndex);
                viewportData = {
                  studyInstanceUid: studyInstanceUid,
                  displaySetInstanceUid: displaySetInstanceUid,
                  stack: stack
  ...
  createClass(OHIFCornerstoneViewport, [{
    ...
    value: function setStateFromProps() {
      ...
      var sopClassUid = sopClassUids && sopClassUids[0];
      this.getViewportData(studies, studyInstanceUid, displaySetInstanceUid, sopClassUid, sopInstanceUid, frameIndex).then(function (viewportData) {
        _this2.setState({
    ...
    value: function componentDidUpdate(prevProps) {
      var _this$props$viewportD2 = this.props.viewportData,
          studies = _this$props$viewportD2.studies,
          displaySet = _this$props$viewportD2.displaySet;
    ...
    value: function render() {
      ...
      var childrenWithProps = null; // TODO: Does it make more sense to use Context?
      ...
      return React.createElement(React.Fragment, null, this.state.viewportData && React.createElement(ConnectedCornerstoneViewport, _extends_1({
    ...
    value: function getCornerstoneStack(studies, studyInstanceUid, displaySetInstanceUid, sopInstanceUid) {
      ...
      var storedStack = StackManager$1.findOrCreateStack(study, displaySet); // Clone the stack here so we don't mutate it
...
defineProperty(OHIFCornerstoneViewport, "defaultProps", {
  customProps: {}
});

defineProperty(OHIFCornerstoneViewport, "propTypes", {
...
defineProperty(OHIFCornerstoneViewport, "id", 'OHIFCornerstoneViewport');

defineProperty(OHIFCornerstoneViewport, "getViewportData", function (studies, studyInstanceUid, displaySetInstanceUid, sopInstanceUid, frameIndex) {
  return OHIFCornerstoneViewport.getCornerstoneStack(studies, studyInstanceUid, displaySetInstanceUid, sopInstanceUid, frameIndex);
});

var actions = {
  rotateViewport: function rotateViewport(_ref) {
    var viewports = _ref.viewports,
        rotation = _ref.rotation;

    var enabledElement = _getActiveViewportEnabledElement(viewports.viewportSpecificData, viewports.activeViewportIndex);
  ...
  flipViewportHorizontal: function flipViewportHorizontal(_ref2) {
  ...
  flipViewportVertical: function flipViewportVertical(_ref3) {
  ...
  scaleViewport: function scaleViewport(_ref4) {
  ...
  resetViewport: function resetViewport(_ref5) {
    var viewports = _ref5.viewports;
  ...
  invertViewport: function invertViewport(_ref6) {
    var viewports = _ref6.viewports;
  ...
  setToolActive: function setToolActive(_ref7) {
    var toolName = _ref7.toolName;
  ...
  updateViewportDisplaySet: function updateViewportDisplaySet(_ref8) {
    var direction = _ref8.direction;
    // TODO
    console.warn('updateDisplaySet: ', direction);
  },
  clearAnnotations: function clearAnnotations() {
    console.warn('clearAnnotations: not yet implemented'); // const toolState =
