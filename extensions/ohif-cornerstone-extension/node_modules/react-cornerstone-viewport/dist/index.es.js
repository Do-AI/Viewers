...
function (_PureComponent) {
  ...
  function ImageScrollbar() {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onChange", function (event) {
      var intValue = parseInt(event.target.value, 10);

      _this.props.onInputCallback(intValue);
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onKeyDown", function (event) {
...
function (_Component) {
  ...
  function CornerstoneViewport(props) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "updateViewportSpecificData", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onContextMenu", function (event) {
      event.preventDefault();
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onWindowResize", function () {
      _this.debouncedResize();
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onImageRendered", function (event) {
      _this.setState({
        viewport: Object.assign({}, event.detail.viewport)
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onNewImage", function (event) {
      _this.setState({
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onDoubleClick", function (event) {
      if (_this.props.onDoubleClick) {
        _this.props.onDoubleClick(event);
      }
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setActiveTool", function (activeTool) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onStackScroll", function (event) {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onImageLoaded", function () {
      _this.setState({
        numImagesLoaded: _this.state.numImagesLoaded + 1
      });
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "startLoadingHandler", function () {
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "doneLoadingHandler", function () {
      clearTimeout(_this.loadHandlerTimeout);
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onMeasurementAdded", function (event) {
      if (_this.props.onMeasurementsChanged) {
        _this.props.onMeasurementsChanged(event, 'added');
      }
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onMeasurementRemoved", function (event) {
      if (_this.props.onMeasurementsChanged) {
        _this.props.onMeasurementsChanged(event, 'removed');
      }
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onMeasurementModified", function (event) {
      if (_this.props.onMeasurementsChanged) {
        _this.props.onMeasurementsChanged(event, 'modified');
      }
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "setViewportActive", function () {
      if (!_this.props.isActive && _this.props.setViewportActive) {
        _this.props.setViewportActive();
      }
    });

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onMouseClick", function (event) {
      _this.setViewportActive();
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onTouchPress", function (event) {
      _this.setViewportActive();
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "onTouchStart", function () {
      _this.setViewportActive();
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "imageSliderOnInputCallback", function (value) {
      _this.setViewportActive();
