(function (global, factory) {
	...
	(global = global || self, factory(global.NProgress = {}, global.PropTypes, global.React));
	...
	function (_React$Component) {
	  inheritsLoose(NProgress, _React$Component);
	  ...
	  _proto.render = function render() {
	    return this.props.children(_extends_1({}, this.state, {
	...
	function withNProgress(BaseComponent) {
	  var WithNProgress = function WithNProgress(props) {
	    return React.createElement(NProgress, props, function (p) {
	      return React.createElement(BaseComponent, _extends_1({}, props, p));
	    });
	  };
